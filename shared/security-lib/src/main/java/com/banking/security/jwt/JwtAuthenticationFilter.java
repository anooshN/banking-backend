...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private String extractJwtFromRequest(HttpServletRequest request) {
        String bearerToken = request.getHeader(BankingConstants.AUTHORIZATION_HEADER);
        if (StringUtils.hasText(bearerToken) && bearerToken.startsWith(BankingConstants.BEARER_PREFIX)) {
